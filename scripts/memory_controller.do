...
add wave -noupdate -divider -height 25 <NULL>
add wave -noupdate /memory_control_tb/cpuif/memREN
add wave -noupdate /memory_control_tb/cpuif/memWEN
add wave -noupdate /memory_control_tb/cpuif/memaddr
add wave -noupdate /memory_control_tb/cpuif/memstore
add wave -noupdate /memory_control_tb/cpuif/ramREN
add wave -noupdate /memory_control_tb/cpuif/ramWEN
add wave -noupdate /memory_control_tb/cpuif/ramaddr
add wave -noupdate /memory_control_tb/cpuif/ramload
add wave -noupdate /memory_control_tb/cpuif/ramstate
add wave -noupdate /memory_control_tb/cpuif/ramstore
